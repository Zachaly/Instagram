...
namespace Instagram.Database.Sql
{
    public class SqlQueryBuilder : ISqlQueryBuilder
    {
        ...
        {
            var select = new StringBuilder($"SELECT t.* /**outsideselect**/ FROM (SELECT /**select**/ FROM [{table}] /**subjoin**/ /**conditionaljoin**/ /**where**/ /**orderby**/ /**pagination**/) as t /**join**/ /**groupby**/ /**outerOrderBy**/");
